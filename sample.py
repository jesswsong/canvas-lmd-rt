...
def main(args, param):
    ...
    # print(f"FORMAT DICT V1:{text_format_dict}")
    ...
    # print(f"FORMAT DICT V2:{text_format_dict}")
    ...
    # this is where the plain image was generated
    ...
    # plain_img is a StableDiffusionXLPipelineOutput output
    ...
    # passing in color_Target_token_ids as obj tokens
