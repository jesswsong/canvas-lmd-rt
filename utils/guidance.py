...
# key = "gligen/diffusers-generation-text-box"
# d_version = "sdv1.4"
# if use_fp16:
#     dtype = torch.float16
#     revision = "fp16"
...
# lmd_vae = AutoencoderKL.from_pretrained(key, subfolder="vae", revision=revision, torch_dtype=dtype).to(device)
...
#                 img = decode(lmd_vae, latents_inp.to(dtype=torch.float32)).sample
